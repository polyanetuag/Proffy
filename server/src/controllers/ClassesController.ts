...
export default class ClassesController {
    async index(request: Request, response: Response){              //Listagem das aulas
        ...
        const subject = filters.subject as string;                  //Conversão para a tipagem ts 
        ...
        const classes = await db('classes')
            ...
            .join('users', 'classes.user_id', '=', 'users.id')          //Relaciona a matéria com o id do professor/usuário
